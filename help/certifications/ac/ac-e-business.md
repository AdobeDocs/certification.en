...
solution: Commerce
role: Developer
badge: label="Exam ADO-E708" type="positive"
---
...
* [Shipping and delivery](https://docs.magento.com/user-guide/shipping/delivery.html){target="_blank"} 
* [Order management and operations](https://docs.magento.com/user-guide/sales/order-management.html){target="_blank"} 
* [Gift cards](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/getting-started/merchants/3-8-gift-cards.html){target="_blank"} 
* [Gift card product](https://docs.magento.com/user-guide/catalog/product-gift-card.html){target="_blank"} 
...
* [Introduction to Product Recommendations](https://docs.magento.com/user-guide/marketing/product-recommendations.html){target="_blank"}
...
* [PSI](https://www.certmetrics.com/adobe/candidate/psi_sso_adobe.aspx?redir=yes&ec=AD0-E708){target="_blank"} (Modality: Test Center, remote online)
* [Examity](https://www.certmetrics.com/adobe/candidate/examity_sso.aspx?eid=AD0-E708){target="_blank"} (Modality: Remote online)
